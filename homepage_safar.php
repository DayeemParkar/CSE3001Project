...
<!--navbar-->
  ...
  <div class="modal-dialog">
    ...
    <input type="Password" class="form-control" id= "username" placeholder="Password" name="username">
    </div>
...
<div class= "container-fluid" style="margin:auto">
  <div class="col-md-4 w3-animate-left" id="darshan" align="center"> 
    ...
    <div class= "panel panel-info" style="overflow-y: scroll;" align="center">
      <div class= "panel-heading">
        <h4 class= "panel-title"> Sign-up with Shuttle Cab Management System </h4>
      </div> 

    <div class= "panel panel-body">
<form id="form1" action="#" method="POST" align="center">
    <div class="form-group has-feedback">
...
<div class="form-group has-feedback">
    ...
    <input type="text" class="form-control" name="newname" id= "name" placeholder="Name:">
    <i class="glyphicon glyphicon-user form-control-feedback"></i>
</div>
  ...
  <div class="form-group has-feedback">
    ...
    <input type="Password" class="form-control" id="locality" name="locality" placeholder="Password">
...
<div class="w3-container w3-2018-sailor-blue w3-hover-black w3-animate-bottom" id="adv">
  ...
  <p>Save your time with scheduled ride</p>
</div>
</div>
</div>
...
if($conn->connect_error){
    ...
    {
        echo '<script type="text/javascript">
        window.location="http://localhost/ShuttleCabmgmtsys/homepage_safar.php";
      </script>'; 
	  }		
	unset ($_POST['login']);
}
